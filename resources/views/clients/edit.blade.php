            ...
            <form method="POST" action="{{ route('clients.update', $client->id ) }}" class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control @error('cnpj') is-invalid @enderror" name="cnpj" id="cnpj" value="{{ $client->cnpj ?? old('cnpj') }}" maxlength="16">
                ...
                <div class="col-md-8">
                    ...
                    <input type="text" class="form-control @error('corporate_name') is-invalid @enderror"
                        name="corporate_name" id="corporate_name"  value="{{ $client->corporate_name ?? old('corporate_name') }}" maxlength="150">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control @error('responsible_name') is-invalid @enderror"
                        name="responsible_name" id="responsible_name"  value="{{ $client->responsible_name ?? old('responsible_name') }}" maxlength="50">
                ...
                <div class="col-md-4 mt-3">
                    ...
                    <input type="text" class="form-control @error('neighborhood') is-invalid @enderror"
                        name="neighborhood" id="neighborhood"  value="{{ $client->neighborhood ?? old('neighborhood') }}" maxlength="50">
                    @error('neighborhood')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
