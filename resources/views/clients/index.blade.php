                                    ...
                                    <tr>
                                        ...
                                        <td class="" style="white-space: nowrap;">
                                            ...
                                            @if( auth()->user()->can("clients.edit") || auth()->user()->isAdmin() )
                                                <a href="{{route('clients.edit', $row->id)}}" class="btn btn-primary ">{{ __('Edit') }}</a>
                                            @endif
                                            ...
                                            @if( auth()->user()->can("clients.destroy") || auth()->user()->isAdmin() )
                                                ...
                                                <form id="remove-form-{{$row->id}}" action="{{route("clients.destroy", $row->id)}}" method="POST" class="d-none">
                                                    @csrf
                                                    @method("DELETE")
                                                </form>
